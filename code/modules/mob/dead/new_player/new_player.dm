...
/mob/dead/new_player/proc/make_me_an_observer()
	...
	var/this_is_like_playing_right = alert(src,"Are you sure you wish to observe? You are allowed to respawn as a new character! Do not play the same character, unless they are alive and have been successfully cryo'd. You are also not allowed to meta-game!","Player Setup","Yes","No")
